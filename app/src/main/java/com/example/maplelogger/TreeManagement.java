...
public class TreeManagement extends AppCompatActivity {

    private ActivityTreeManagementBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = ActivityTreeManagementBinding.inflate(getLayoutInflater());
